...
List<GastoFP>    detalleporFecha(String fechaini, String fechafin);
List<GastoFP>    detalleporProducto(String fechaini, String fechafin);
...
int            getMaxFPago();
Fpago          findFPagoXGasto(int idg);
int            saveFormadePago(Fpago fpago);
int            actualizarFPago(Fpago fpago);   
